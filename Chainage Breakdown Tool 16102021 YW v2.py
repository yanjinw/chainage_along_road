...
feat_original=vlayer1.getFeatures()
...
fn = 'C:\Yanjin\Module3PracExv2\Module3PracEx\output2.shp'
...
for feature in iter:
    AssetID=iter['Asset_ID']
    PrimaryLocation=iter['Road_Name']
    RoadName=iter['Road_Name']
    Location=iter['from']
...
#        Writing data of chainage onto the output file
            ...
            feat.setGeometry(point)    
            feat.setAttributes([RoadName,length,PrimaryLocation,AssetID,Location])
            writer.addFeature(feat)
            e=e+length
